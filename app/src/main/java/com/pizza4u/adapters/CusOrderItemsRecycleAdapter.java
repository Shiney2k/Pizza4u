...
public class CusOrderItemsRecycleAdapter extends RecyclerView.Adapter<CusOrderItemsRecycleAdapter.OrderItemsViewHolder> {
    ...
    public OrderItemsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CusOrderItemsRecycleAdapter.OrderItemsViewHolder(view);
    }
